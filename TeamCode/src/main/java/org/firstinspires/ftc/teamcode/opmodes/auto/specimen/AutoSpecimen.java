                                ...
                                new ParallelAction(
                                                ...
                                                new SequentialAction(
                                                                ...
                                                                drive.actionBuilder(START.pose)
                                                                        ...
                                                                        .build(),
                                                                hangSequence(new RobotPosition(-8, TEST_Y_VALUE2, Math.toDegrees(START.heading))),
                                                                drive.actionBuilder(new Pose2d(new Vector2d(-8, TEST_Y_VALUE2), START.heading))
                                                                ...
                                                                pickupAndScoreSequence(START, PICKUP1,
                                                                                        ConfigVariables.AutoTesting.Z_LowerslideExtend_FIRST),
                                                                pickupAndScoreSequence(PICKUP1, PICKUP2,
                                                                ...
                                                                lowerSlideCommands.setSpinClawDeg(
                                                                                ConfigVariables.LowerSlideVars.ZERO
                                                                                                + 90),
                                                                pickupAndScoreSequence(PICKUP2, PICKUP3, ConfigVariables.AutoTesting.Z_LowerslideExtend_THIRD),
                                                                ...
                                                                drive.actionBuilder(PICKUP3.pose)
                                                                        .strafeToLinearHeading(new Vector2d(-41.5, PICKUP3.pos.y), Math.toRadians(310))
                                                                        .strafeTo(new Vector2d(-41.5, TEST_Y_VALUE3-4))
                                                                        .waitSeconds(0.1)
                                                                        .strafeTo(new Vector2d(-41.5, TEST_Y_VALUE3))
                                                                        .build(),

                                                                grabFromTeamBox(new RobotPosition(-41.5, TEST_Y_VALUE3, 310)),
                                                                drive.actionBuilder(new RobotPosition(-41.5, TEST_Y_VALUE3, 310).pose)
