...
/**
 * transfer action for the upper slide.
 */
public class UpperSlideTransferCommand extends CommandBase {
        private final UpperSlide upSlide;
        private boolean started = false;
        private long startTime = 0;
        private static final long SERVO_DELAY = 400;

        public UpperSlideTransferCommand(UpperSlide upSlide) {
        ...
        public void execute(TelemetryPacket packet) {
                if (!started) {
                        ...
                        packet.put("upslideAction", "Transfer started");
                        return;
                }
