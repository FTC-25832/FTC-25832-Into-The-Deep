...
public final class ThreeDeadWheelLocalizer implements Localizer {
        public static class Params {
                public double par0YTicks = -9656.109385333115; // y position of the first parallel encoder (in tick
                                                               // units)
                public double par1YTicks = 9807.41929810449; // y position of the second parallel encoder (in tick
                // units)
                public double perpXTicks = -2258.2196843946817; // x position of the perpendicular encoder (in tick
                // units)
        ...
        public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
                ...
                par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, control.motor(0))));
                par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, control.motor(3))));
                perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, control.motor(2))));
